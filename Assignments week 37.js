...
const sentence =
  "Debugging is like being a detective in a crime drama where you are also the murderer.";
...
const phoneNumbers = [11111111, 22222222, 33333333, 44444444, 55555555];
...
for (let index = 4; index >= 0; index--) {
  if (index == 4) {
    console.log(phoneNumbers[index]);
  }
}
...
for (let index = 0; index < peopleNames.length; index++) {
  let lastName = peopleNames[index][1];
